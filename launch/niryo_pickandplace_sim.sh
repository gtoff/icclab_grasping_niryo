...
rosrun timed_roslaunch timed_roslaunch.sh 30 icclab_grasping_niryo rviz_grasps_filter_sim.launch &


#rosrun timed_roslaunch timed_roslaunch.sh 30 icclab_grasping_niryo planar_segm_ros_pcl.launch &

#rosrun timed_roslaunch timed_roslaunch.sh 40 icclab_grasping_niryo rviz_grasps_cluster_sim.launch &


sleep 30

read -n 1 -s -r -p "Press any key to shut down all nodes"
